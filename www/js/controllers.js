...
.controller('MapCtrl', function($scope, $http){
  ...
  $scope.places = [
    {
      ...
      'address' : '5640 S. University Ave., Chicago, IL',
      'hours'   : 'M-Su 10am - 3am',
      'coords'  : {'lat': 41.791817, 'long': -87.598456}
    },
    {
      'name'    : 'Midway Market',
      'address' : '6031 S. Ellis Ave., Chicago, IL',
      'hours'   : 'M-Su 10am- 3am',
      'coords'  : {'lat': 41.785025, 'long': -87.600349}
    },
    {
      'name'    : 'Bio Cafe',
      'address' : '924 East 57th St., Chicago, IL',
      'hours'   : 'M-Fr 8am - 3pm',
      'coords'  : {'lat': 41.791760, 'long': -87.602787}
    },
    {
      'name'    : 'Classics Cafe',
      'address' : '1010 E. 59th St., Chicago, IL',
      'hours'   : 'M-Fr 8am - 3pm',
      'coords'  : {'lat': 41.787911, 'long': -87.600828}
    },
    {
      'name'    : 'Einstein Brothers Bagels',
      'address' : '5706 S. University Ave., Chicago, IL',
      'hours'   : 'M-Fr 7am - 11pm, Sa-Su 9am - 11pm',
      'coords'  : {'lat': 41.790914, 'long': -87.598263}
    },
    {
      'name'    : 'Gordon Cafe',
      'address' : '927 E. 57th St., Chicago, IL',
      'hours'   : 'M-Fr 8am - 3pm',
      'coords'  : {'lat': 41.791102, 'long': -87.602719}
    },
    {
      'name'    : 'Harris Cafe',
      'address' : '1155 E. 60th St., Chicago, IL',
      'hours'   : 'M-Fr 8am - 3pm & 4-7pm',
      'coords'  : {'lat': 41.785644, 'long': -87.597098}
    },
    {
      'name'    : 'Hutchinson Commons',
      'address' : '5706 S. University Ave., Chicago, IL',
    ...
    },
    {
      ...
      'address' : '1111 E. 60th St., Chicago, IL',
      'hours'   : 'M-Th 8am - 5pm, Fr 8am - 3:30pm',
      'coords'  : {'lat': 41.785060, 'long': -87.599001}
    },
    {
      'name'    : 'Cafe Logan',
      'address' : '915 E. 60th St., Chicago, IL',
      'hours'   : 'M-Fr 8am - 8pm, Sa-Su 12pm-8pm',
      'coords'  : {'lat': 41.785450, 'long': -87.603927}
    },
    {
      'name'    : 'Press Cafe',
      'address' : '1427 E. 60th St., Chicago, IL',
      'hours'   : 'M-Fr 8am - 3pm',
      'coords'  : {'lat': 41.785783, 'long': -87.590542}
    },
    {
      'name'    : 'SSA Cafe',
      'address' : '969 E. 60th St., Chicago, IL',
      'hours'   : 'M-Th 8am - 3pm',
      'coords'  : {'lat': 41.785580, 'long': -87.601735}
    },
    {
      'name'    : 'Stuart Cafe',
      'address' : '5835 S. Greenwood Ave., Chicago, IL',
      'hours'   : 'M-Fr 8am - 3pm',
      'coords'  : {'lat': 41.788401, 'long': -87.599099}
    },
    {
      'name'    : 'Tiffin Cafe',
      'address' : '1414 E. 59th St., Chicago, IL',
      'hours'   : 'M-Su 4pm-12am',
      'coords'  : {'lat': 41.788077, 'long': -87.590951}
    },
    {
      'name'    : 'Starbucks at Saieh Hall',
      'address' : '5757 S. University Ave., Chicago, IL',
      'hours'   : 'M-Fr 7am - 6pm',
      'coords'  : {'lat': 41.789978, 'long': -87.598015}
    },
    {
      'name'    : 'Barnes & Noble Bookstore Cafe',
      'address' : '970 E 58th st., Chicago, IL',
      'hours'   : 'M-Fr 7am - 6pm, Sa 9am-4pm',
      'coords'  : {'lat': 41.789560, 'long': -87.602033}
    },
  ];
  ...
  function initMap(crds) {
    ...
    // add the markers for all the places
    for(var i = 0; i < $scope.places.length; i++) {
      var address = $scope.places[i]['address'];
      var name = $scope.places[i]['name'];
      var coordinates = $scope.places[i]['coords'];
      var markerLocation = new google.maps.LatLng(coordinates.lat, coordinates.long);
  ...
  function success(position) {
    ...
    initMap({"latitude" : 41.792000, "longitude" : -87.598120, "accuracy" : 15});
  };
